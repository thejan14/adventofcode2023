...
int getDistance(std::array<bool, DIM> const& galaxyRows, std::array<bool, DIM> const& galaxyColumns, pos const& galaxy1, pos  const& galaxy2)
{
	auto distance = 0;
